...
--TIMESLOT DATA
insert into TimeSlot(StartTime, EndTime) values ('7:00','12:00') --làm việc sáng
insert into TimeSlot(StartTime, EndTime) values ('12:00','18:00') --làm việc chiều
...
--SCHEDULE DATA
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 4, '2024-06-19', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 5, '2024-06-20', N'Nghỉ')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 6, '2024-06-21', N'Nghỉ')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 7, '2024-06-20', N'Nghỉ')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 4, '2024-06-20', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 5, '2024-06-09', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 6, '2024-06-09', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(1, 7, '2024-06-09', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(2, 5, '2024-06-21', N'Nghỉ')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(2, 5, '2024-06-24', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(2, 6, '2024-06-22', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(2, 7, '2024-06-21', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(3, 3, '2024-06-23', N'Nghỉ')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(3, 4, '2024-06-07', N'Đã Đặt')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(3, 5, '2024-06-23', N'Nghỉ')
insert into Schedule(DentistID, TimeSlotID, Date, ScheduleStatus) values(3, 6, '2024-06-23', N'Nghỉ')
