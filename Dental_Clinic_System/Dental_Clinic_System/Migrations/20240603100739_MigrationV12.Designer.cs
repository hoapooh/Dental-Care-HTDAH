...
namespace Dental_Clinic_System.Migrations
{
    ...
    [Migration("20240603100739_MigrationV12")]
                    ...
                    b.ToTable("Account", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Valid_Status_Account", "[AccountStatus] = 'Active' OR [AccountStatus] = 'Banned' OR [AccountStatus] = N'Hoạt Động' OR [AccountStatus] = N'Bị Khóa'");
                        });
                });
