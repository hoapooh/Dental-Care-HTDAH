            ...
            modelBuilder.Entity("Dental_Clinic_System.Models.Data.FutureAppointment", b =>
                {
                    ...
                    b.ToTable("PeriodicAppointments", t =>
                        {
                            t.HasCheckConstraint("CK__Valid_FutureAppointmentStatus", "PeriodicAppointmentStatus = 'Chưa Khám' OR PeriodicAppointmentStatus = 'Đã Khám' OR PeriodicAppointmentStatus = 'Đã Hủy'");
                        });
                });
