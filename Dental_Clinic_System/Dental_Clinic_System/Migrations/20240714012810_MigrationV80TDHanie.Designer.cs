...
namespace Dental_Clinic_System.Migrations
{
    ...
    [Migration("20240714012810_MigrationV80TDHanie")]
    partial class MigrationV80TDHanie
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dental_Clinic_System.Models.Data.Schedule", b =>
                {
                    ...
                    b.ToTable("Schedule", t =>
                        {
                            t.HasCheckConstraint("CK_Valid_Schedule_Status", "ScheduleStatus = N'Đã Đặt' OR ScheduleStatus = N'Còn Trống' OR ScheduleStatus = N'Lịch khám' OR ScheduleStatus = N'Lịch điều trị' OR ScheduleStatus = N'Lịch Sáng' OR ScheduleStatus = N'Lịch Chiều' OR ScheduleStatus = N'Nghỉ' OR ScheduleStatus = N'Đã Hủy'");
                        });
                });
