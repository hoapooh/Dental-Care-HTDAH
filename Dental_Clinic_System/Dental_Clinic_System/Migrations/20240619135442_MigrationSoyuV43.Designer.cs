...
namespace Dental_Clinic_System.Migrations
{
    ...
    [Migration("20240619135442_MigrationSoyuV43")]
    partial class MigrationSoyuV43
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dental_Clinic_System.Models.Data.PatientRecord", b =>
                {
                    ...
                    b.ToTable("PatientRecord", t =>
                        {
                            t.HasCheckConstraint("CK_Valid_PatientRecord_Status", "PatientRecordStatus = 'Đã Xóa' OR PatientRecordStatus = 'Đang Tồn Tại'");
                        });
                });
