...
//	{
//		public MOMOPayment(string partnerCode, string requestId,
...
//			this.signature = DataEncryptionExtensions.HmacSHA256(rawHash, secretKey);
//		}
...
//					.DeserializeObject<MOMOPaymentResponseModel>(responseContent);
